...
const COPY = {
  en: {
    ...
    nextStep: {
      remote: "Confirm your timeline, budget, and work details so your roadmap reflects your real situation.",
  ...
  ru: {
    ...
    subtitle: "Проверьте выбранное направление и вариант переезда перед созданием плана.",
    destination: "Направление",
    legalPath: "Виза или ВНЖ",
    preparationTime: "Время подготовки",
    blockers: "Главные риски",
    firstStep: "Первый шаг",
    planSnapshot: "Кратко о плане",
    moveBrief: "Сводка переезда",
    moveBriefText:
      "Дальше мы превратим это в понятный план и сводку, с которой проще обсуждать переезд.",
    verificationNote:
      "Юридические требования всё равно нужно проверять по источникам, прежде чем считать это документным планом.",
    createRoadmap: "Создать план",
    changePath: "← Изменить вариант",
    nextStep: {
      remote: "Подтвердите сроки, бюджет и рабочие детали, чтобы план отражал вашу реальную ситуацию.",
      study: "Подтвердите сроки, учебный статус и бюджет перед следующим этапом плана.",
      work: "Подтвердите сроки, рабочий статус и финансовую реальность перед следующим этапом.",
      exploration: "Спланируйте ознакомительную поездку и присмотритесь к районам.",
      family: "Подтвердите, кто переезжает с вами и какие ограничения это создаёт для плана.",
      capital: "Проверьте финансовую реальность перед следующим этапом плана.",
      ...
      fallback: "Проверьте профиль переезда и создайте план.",
    },
  },
