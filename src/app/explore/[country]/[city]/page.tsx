...
const CITY_COPY = {
  ...
  ru: {
    ...
    legalReality: "Что проверить по визе",
    lifestyleReality: "Что может усложнить жизнь",
    fitAssessment: "Насколько подходит",
    fitTitle: "Подходит ли вам этот город?",
    goodFor: "Хорошо подходит",
    hardIf: "Будет сложно, если",
    cityMetrics: "Город в цифрах",
    atGlance: "Кратко",
    financialPicture: "Бюджет и аренда",
    ...
    metrics: {
      ...
      transport: "Транспорт",
      english: "Насколько легко без языка",
    ...
    footerTwo: "Оценки основаны на данных о направлении, вариантах визы или ВНЖ и вашем профиле. Перед решением проверьте актуальные требования.",
  },
...
function LegalPathCard({
  ...
  const scenarioLabel: Record<LegalPath["scenario"], string> = {
    ...
    exploration: language === "ru" ? "Присмотреться" : "Exploration",
