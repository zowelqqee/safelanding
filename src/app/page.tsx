...
const COPY = {
  en: {
    hero: {
      chips: ["Country shortlist", "City decision", "Legal path fit", "Move Brief — your plan"],
    ...
    whatYouGet: {
      ...
      features: [
        ...
        {
          title: "Move Brief — your relocation summary",
          description:
            "A structured summary of your destination, legal path, blockers, and fit scores. Use it to stay clear-headed or share with an advisor.",
        },
      ],
    },
    destinations: {
  ...
  ru: {
    hero: {
      chips: ["Подбор страны", "Выбор города", "Виза или ВНЖ", "Сводка переезда"],
      ...
      routes: [
        ...
        { label: "Вариант переезда", value: "D8 Digital Nomad Visa" },
        { label: "Следующий шаг", value: "Сводка → консультация" },
      ],
      cta: "Начать с анкеты",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "Ранжируем направления по совпадению с вашей ситуацией, а не по общему топ-10. Сохраняйте, сравнивайте, выбирайте.",
        },
        {
          number: "03",
          title: "Выберите город и вариант переезда",
          description:
    ...
    whatYouGet: {
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "Смотрите главный риск, первые 90 дней и то, что люди обычно недооценивают — до того, как вы определитесь.",
        },
        {
          title: "Сводка переезда",
          description:
            "Структурированная сводка по направлению, визе или ВНЖ, рискам и оценке совпадения. Используйте для ясности или покажите советнику.",
        },
      ],
    },
    destinations: {
      ...
      subtitle:
        "Южная Европа, Центральная Европа, Северная Америка, Ближний Восток, Центральная Азия и Азия — с анализом страны, города и вариантов визы или ВНЖ.",
      explore: "Обзор",
    ...
    cta: {
      ...
      subtitle:
        "Начните бесплатно. Аккаунт не нужен, чтобы увидеть подборку стран и варианты визы или ВНЖ.",
