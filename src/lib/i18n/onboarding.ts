...
export const welcomeCopy = {
  ...
  ru: {
    ...
    description:
      "Soft Landing помогает выбрать страну и город, понять реальные варианты визы или ВНЖ, собрать профиль переезда и двигаться по понятному плану.",
    time: "Займёт около 3 минут. Результаты можно посмотреть без аккаунта.",
    roadmapKicker: "Продолжить план",
    roadmapText: "Город и вариант переезда уже выбраны.",
    roadmapButton: "Продолжить план",
    onboardingInstead: "Открыть анкету",
    resumeKicker: "Продолжить переезд",
    stoppedAt: "Вы остановились на:",
    resumeButton: "Продолжить",
    startOver: "Начать заново",
    startButton: "Начать с анкеты",
    disclaimer:
...
export const baseCopy = {
  ...
  ru: {
    title: "Откуда вы?",
    subtitle: "Это помогает подобрать реалистичный вариант визы или ВНЖ.",
...
export const goalCopy = {
  ...
  ru: {
    ...
    subtitle: "Подберём подходящий тип города и вариант переезда.",
    options: [
...
export const preferenceCopy = {
  ...
  ru: {
    ...
    options: [
      ...
      { value: "expat_community", label: "Сообщество переехавших", emoji: "🌍" },
...
export const fearCopy = {
  ...
  ru: {
    ...
    options: [
      ...
      { value: "legal_status", label: "Виза или статус", description: "Отказ по визе или неясные правила" },
    ],
  },
} satisfies Record<UiLanguage, {
  title: string;
...
export const optimizationCopy = {
  ...
  ru: {
    ...
    options: [
      { value: "fastest_legal_path", label: "Самый быстрый путь к статусу", description: "Получить визу или ВНЖ с минимумом бюрократии", emoji: "⚡" },
      ...
      { value: "comfortable_life", label: "Комфортная повседневность", description: "Качество жизни, безопасность, сообщество, ритм", emoji: "🌿" },
      { value: "best_study", label: "Лучший учебный путь", description: "Университеты и студенческая среда", emoji: "🎓" },
      { value: "safest_longterm", label: "Самый надёжный долгосрочный вариант", description: "Стабильный статус, понятный путь к ПМЖ, сильные институты", emoji: "🛡️" },
    ],
    ...
    safetyOptions: [
      ...
      { value: "low", label: "Гибко", description: "Готов терпеть часть риска ради сильных перспектив" },
    ],
    ...
    studyOptions: [
      { value: "top_university", label: "Сильный университет", description: "Престиж, качество исследований и международная репутация" },
      { value: "scholarship_chance", label: "Гранты", description: "Шансы на финансирование, стипендии и оплачиваемые позиции" },
      { value: "post_study_work", label: "Работа после учёбы", description: "Карьерный путь после выпуска" },
      { value: "affordable_degree", label: "Доступный диплом", description: "Ниже стоимость обучения и давление на бюджет" },
    ],
  },
} satisfies Record<UiLanguage, {
  title: string;
